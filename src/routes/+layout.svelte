...
<svelte:head>
	...
	<meta name="description" content="Zackary Santana's custom portfolio!" />
	<meta
		name="keywords"
...
<style>
	...
	@font-face {
		...
		src: url('/fonts/QueensidesLight.ttf') format('truetype');
		font-weight: 400;
	}

	@font-face {
		font-family: 'Queensides';
		src: url('/fonts/QueensidesMedium.ttf') format('truetype');
		font-weight: 500;
	}
